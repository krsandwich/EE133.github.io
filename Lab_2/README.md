...
## Conclusion
In this lab, we studied the important of clock generators and their many applications in modern circuits. Then we demonstrated how to setup and program the SI5351 using an ItsyBitsy and CircuitPython. Finally, we tested the observed that the output degrades at higher frequencies which makes the SI5351 unsuitable for projects requiring precise timing at higher frequencies. 
